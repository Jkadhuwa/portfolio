      ...
      <article className="grid grid-cols-1 h-screen justify-center  md:grid-cols-2 mt-24">
        ...
        <div className="place-items-center font-extralight md:mt-0 lg:-ml-12">
          ...
          <p className="-ml-4 -mt-4 justify-center md:flex flex-wrap text-xl text-center px-12 lg:mt-4">
            I am a passionate Full stack Software Developer with vast experince in
            web applications using Javascript, NodeJS, ReactJS, Mongo, PostgreSQL and
            other libraries and frameworks. A 2017 graduate from Kabarak University,
            School of Science and Bio-Informatics in Nakuru Kenya with a Second Class
      ...
      <article className="h-5/6 grid bg-white justify center md:grid-cols-2 -mt-24">
        ...
        <div className="mt-20 mr-16  text-xl font-extralight mb-24">
          ...
          <div className="ml-16 md:ml-0">
            <p>
              ⚡ I design and build responsive and highly attractive web application
              frontends
            </p>
            <p>
              ⚡ I create application backend using Laravel framework, NodeJs and
              Express framework.
            </p>
            <p>
              ⚡ I use the Test-Driven Development (TDD) methodology to develop all
              the applications.
            </p>
            <p>
